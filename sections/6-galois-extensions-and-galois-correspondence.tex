...
By Theorem \ref{thm:separable-extension-in-C}, for a finite field extension in $\C$, being ``Galois'' is a synonym of being ``normal''. 

We now give some further properties for Galois extensions in general fields.
